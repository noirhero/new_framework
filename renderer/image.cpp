...
namespace Image {
    ...
    Dimension2UPtr CreateFourPixel2D(uint8_t r, uint8_t g, uint8_t b, uint8_t a, Command::Pool& cmdPool) {
        constexpr VkDeviceSize width = 4;
        constexpr VkDeviceSize pixelSize = 4/*r, g, b, a*/ * 4/*width*/ * 4/*height*/;
        const uint8_t pixels[pixelSize]{
            r, g, b, a,
            r, g, b, a,
            r, g, b, a,
        ...
        memcpy_s(staging.info.pMappedData, pixelSize, pixels, pixelSize);
